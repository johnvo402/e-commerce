...
namespace App.Areas.Identity.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, IEmailSender emailSender, ILogger<ManageController> logger, INotyfService inotiyfyservice, IConfiguration configruation)
        {
        ...
        [HttpPost("/uploadavt/")]
        public async Task<IActionResult> UploadImgAsync([Bind("FileUp")] UploadFile file)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var file2 = Path.Combine("wwwroot", "images", "icons", file1);
            ...
            _Inotiyfyservice.Success("Update Avatar Successfully!", 3);
        ...
        public async Task<IActionResult> EditProfileAsync(EditExtraProfileModel model)
        {
            ...
            await _signInManager.RefreshSignInAsync(user);
            _Inotiyfyservice.Success("Update profile successfully!", 3);
            return RedirectToAction(nameof(Index), "Manage");
        ...
        [HttpPost]
        public async Task<IActionResult> CancelRegisterSeller()
        {
            var user = await GetCurrentUserAsync();
